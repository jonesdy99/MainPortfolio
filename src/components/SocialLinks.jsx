  ...
  const links = [
    {
      ...
      href: 'https://www.linkedin.com/in/dylan-jones-8b3365122/',
      style: 'rounded-tr-md'
    },
    {
      id: 2,
      child: (
        <>
          GitHub <FaGithub size={30} className='ml-7'/>
        </>
      ),
    ...
    },
    {
      ...
      child: (
        <>
          Mail <HiOutlineMail size={30} className='ml-12'/>
        </>
      ),
    ...
    <div className='hidden lg:flex flex-col top-[35%] left-0 fixed'>
      <ul>
        ...
        <li key={id} className={"flex justify-between items-center w-40 h-14 px-4 ml-[-100px] bg-gray-500 hover:ml-[-10px] hover:rounded-md duration-300" + " " + style}>
            <a href={href} 
            className='flex justify-between items-center w-40 h-14 px-4 text-white' 
            download={download} 
            target='_blank' 
            rel='noreferrer'>
              {child}
